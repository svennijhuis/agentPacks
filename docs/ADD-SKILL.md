...
A user-invoked entrypoint (`squad`, `pack-check`, `learnings-digest`, `scenarios-md`, `security-audit`) adds
...
Do not publish to a marketplace branch or merge to `main` to test a skill. These commands
