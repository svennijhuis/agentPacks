...
portable skills exist once. The Cursor catalog stays a thin name/source/description list so Codex,
which discovers `.cursor-plugin/marketplace.json` fourth, does not treat it as a Codex catalog.
