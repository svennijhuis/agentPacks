...
5. Prove the plan's test-plan matrix. Name behavioral + edge coverage. Reject happy-path-only coverage. Do not edit a test to make it pass. Do not edit source. Return the verifier report. Do not commit.
