...
3. TDD: failing test first from the plan's test-plan matrix, including an edge case. Happy-path-only tests are rejected. Do not run the full suite. Implement criterion by criterion.
