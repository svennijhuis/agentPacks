...
`write-plan`: require confirmation and an empty frontier. Write exactly `docs/plans/<slug>.md`. Each business criterion gets a test-plan matrix row: happy / edge / fail + unit vs integration. Deployed/API: cite smoke-matrix.
