...
2. Standards in force: `csharp.md`, `async-errors.md`, `testing.md`, `layers.md`, `http-api.md`.
...
Good: cite `async-errors.md` on a fire-and-forget `Task`; Fix names the repo analyzer when it already flags it.
Bad: "looks fine" with no location or standard; a new prose rule for a pattern the analyzer already flags.
