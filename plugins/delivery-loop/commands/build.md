...
8. Give the completed reports, verifier evidence, round number, plan path, and security decision to
   `loop-orchestrator` for normalization, merge, and verdict only. If it returns an input error,
