...
/// <summary>
/// Builds the repo-root catalog Cursor Team Marketplace import, public submit, and
/// <c>agent plugin marketplace add --git-ref</c> read at .cursor-plugin/marketplace.json.
/// Official Cursor catalogs are a thin name/source/description list
/// (schemas/marketplace.schema.json, additionalProperties: false). Component routing belongs
